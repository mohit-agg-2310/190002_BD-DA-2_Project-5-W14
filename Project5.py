#MOHIT
#190002
# project-5: wholesaledata


# Import a dataset and needed libraries
import pandas as pd
import numpy as np
...
# Loading data.
dataset = spark.read.format("com.databricks.spark.csv").option("header", "true").load("Wholesaledata.csv")
...
# Slicing the data. but first explore the data for best slicing points
indices = [43, 12, 39]
